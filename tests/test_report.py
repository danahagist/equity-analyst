...
def _report() -> str:
    ...
    pm = PMSynthesis(
        ...
        "medium",
        "6-12mo",
        "Net constructive despite valuation risk.",
        ["Valuation compression", "Execution risk"],
        [
            "1w: noise-dominated, no edge",
            "1m: constructive on catalysts",
...
def test_report_content() -> None:
    ...
    assert (
        "| 1d | 2026-07-09 | $124.00 | $121.00 – $127.00 | +0.4% | AutoETS | beats drift | 16 |"
        in md
    )
